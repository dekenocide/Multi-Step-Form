// STEPS SCRIPTS
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function getNextStep(current) {
            console.log(`Getting next step from ${current}`);
            return hierarchicalSteps[current]?.next || current;
        }

        function getPrevStep(current) {
            console.log(`Getting previous step from ${current}`);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function handleTemplateVisibility() {
            ...
            if (numberOfGuestsValue === '1') {
                ...
                console.log(`2-Guest arrangement: ${guestArrangementValue}`);
                ...
                console.log(`3-Guest arrangement: ${guestArrangementValue}`);
                ...
                console.log(`4-Guest arrangement: ${guestArrangementValue}`);
                ...
                console.log(`5-Guest arrangement: ${guestArrangementValue}`);
                ...
                console.log(`6-Guest arrangement: ${guestArrangementValue}`);
    ...
    document.addEventListener('DOMContentLoaded', function() {
        console.log("Number of guests conditionals script loaded");
        ...
        function hideAllGuestArrangements() {
            ...
            console.log("All guest arrangements hidden");
        }
        ...
        function resetAndHideChildren(parentSelect) {
            ...
            console.log(`Children of ${parentSelect.id} reset and hidden`);
        }
        ...
        function handleGuestArrangements() {
            ...
            console.log(`Handling guest arrangements for ${numberOfGuestsValue} guests`);
        ...
        numberOfGuests.addEventListener('change', function() {
            console.log("Number of guests selection changed");
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function hideAllConditionals() {
            ...
            console.log("All conditionals hidden");
        }
        ...
        function resetField(field) {
            if (field) {
                ...
                console.log(`Field ${field.id} reset`);
            }
        }
    ...
    function removeEmptyFields(form) {
        ...
        console.log("Empty fields removed from form");
    }
